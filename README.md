...
Version 1.6.0 Created by [Vincent Blanchon](http://developpeur-zend-framework.fr/)
...
Storage options available are : file, session, segment, memcached, apc, zendshm, and zenddisk.
